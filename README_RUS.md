...
Реализация библиотеки lib_matrix

## Contents

1. [Информация](#информация) \
    1.1. [Матрица](#матрица) \
    1.2. [Cтруктура матрицы на языке C](#структура-матрицы-на-языке-c)
2. [Операции над матрицами](#операции-над-матрицами) \
    2.1. [Создание матриц (create_matrix)](#создание-матриц-create_matrix) \
    2.2. [Очистка матриц (remove_matrix)](#очистка-матриц-remove_matrix) \
    2.3. [Сравнение матриц (eq_matrix)](#сравнение-матриц-eq_matrix) \
    2.4. [Сложение (sum_matrix)](#сложение-sum_matrix-и-вычитание-матриц-sub_matrix) \
    2.5. [вычитание матриц (sub_matrix)](#сложение-sum_matrix-и-вычитание-матриц-sub_matrix) \
    2.6. [Умножение матрицы на число (mult_number)](#умножение-матрицы-на-число-mult_number-умножение-двух-матриц-mult_matrix) \
    2.7. [Умножение двух матриц (mult_matrix)](#умножение-матрицы-на-число-mult_number-умножение-двух-матриц-mult_matrix) \
    2.5. [Транспонирование матрицы (transpose)](#транспонирование-матрицы-transpose) \
    2.5. [Матрица алгебраических дополнений (calc_complements)](#минор-матрицы-и-матрица-алгебраических-дополнений-calc_complements) \
    2.5. [Определитель матрицы (determinant)](#определитель-матрицы-determinant) \
    2.5. [Обратная матрица (inverse_matrix)](#обратная-матрица-inverse_matrix)
3. [Реализация функций](#реализация-функций-библиотеки-matrixh) \
    3.1. [Реализация](#реализованы-основные-действия-с-матрицами-частично-описанные-выше)  
...
### Реализованы основные действия с матрицами (частично описанные [выше](#операции-над-матрицами)): 
...
- Не использовались устаревшие и выведенные из употребления конструкции языка и библиотечные функции. Ориентировался на стандарт POSIX.1-2017
- При написании кода придерживался Google Style
- lib_matrix оформлена как статическая библиотека (с заголовочным файлом matrix.h)
...
- Предусмотрен [Makefile](./src/Makefile_RUS.md) для сборки библиотеки и тестов
